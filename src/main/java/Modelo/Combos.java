...
public class Combos implements Serializable {
    ...
    public Combos(String nome, List<Cupcake> sabor, double preco){
        this.nome = nome;
        this.sabor = sabor;
        this.preco = preco;
    }
    ...
    public String toString(){
        return "Combos(" +"nome='" + nome + '\'' +", sabor=" + sabor + ", preco=" + preco +')';
    }
    ...
    public List<Cupcake> getSabor(){
        return sabor;
    }

    public void setSabor(List<Cupcake> sabor){
        this.sabor = sabor;
    }
